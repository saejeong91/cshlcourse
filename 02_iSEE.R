...
## download the data
load("/Users/s_park/Downloads/Human_DLPFC_Visium_processedData_sce_scran_sce_layer_spatialLIBD.Rdata")
...
## ----single_geneExpr------------------------------------------------------------------
## Initial settings for a single gene expression ## can be tried with Cyp26b1
initial_single <- list(
